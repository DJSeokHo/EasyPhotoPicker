package com.swein.easyphotopicker
...
class SystemPhotoPickManager(private val componentActivity: ComponentActivity, private val providerAuthorities: String) {
    ...
    fun takePictureWithFilePath(shouldCompress: Boolean = false, takePathDelegate: (imagePath: String) -> Unit) {
        ...
        tempImageUri = FileProvider.getUriForFile(
            componentActivity, providerAuthorities,
